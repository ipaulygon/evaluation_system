...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2018 at 06:23 PM
...
('2018-02-08 16:56:49', '0000-00-00 00:00:00', 4, 'jd@gmail.com', '$2y$10$JmjppASARHTZOj4pOfSGHuwNASzCRSdC/e4idjiSECUqtYlCDM1i2', 'D04xah6hoNRcBMQHwtdNRqb5HI8MmfHnghazSbG64Xe0VhwPFwt5NYrdtNCK', 2, 0),
...
--
ALTER TABLE `tbl_appraisal`
  MODIFY `id_appraisal` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_appraisal_details`
--
ALTER TABLE `tbl_appraisal_details`
  MODIFY `id_appraisal_details` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
--
-- AUTO_INCREMENT for table `tbl_appraisal_property_picture`
--
ALTER TABLE `tbl_appraisal_property_picture`
  MODIFY `id_property_picture` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tbl_appraise_property`
  MODIFY `id_appraise_property` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tbl_comparable_property`
  MODIFY `id_comparable_property` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
--
...
--
ALTER TABLE `tbl_property`
  MODIFY `id_property` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tbl_property_location`
--
ALTER TABLE `tbl_property_location`
  MODIFY `id_property_location` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
--
...
--
ALTER TABLE `tbl_seller`
  MODIFY `id_seller` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_sell_property`
--
ALTER TABLE `tbl_sell_property`
  MODIFY `id_sell_property` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
